...
export default function About() {
  ...
  return (
    <Flex  flexDirection={window.innerHeight > window.innerWidth ? 'column-reverse' : 'row'} justifyContent={['center', 'center', 'center', 'space-between', 'space-between', 'space-between']} h='100%'>
      <Box as={motion.div} initial={{x : -50, opacity : 0}} animate={{x : 0, opacity : 1}} transition='0.7s' fontSize={[12, 14, 16, 20, 24, 28]} w='100%' display='flex' justifyContent='center' alignItems='center' maxH={['100%', '100%', '100%', '100%', '100%', '100%']}>
      ...
      <Box maxH={['100%', '100%', '100%', '100%', '100%', '100%']} w='100%' display='flex' justifyContent='center' alignItems='center'>
        <Image as={motion.img} initial={{x : 50, opacity : 0}} animate={{x : 0, opacity : 1}} transition='0.7s' display={colorMode === 'light' ? 'block' : 'none'} maxH='100%' src={chairL} boxSize={['250px', '300px', '375px', '450px', '525px', '600px']} />
        <Image as={motion.img} initial={{x : 50, opacity : 0}} animate={{x : 0, opacity : 1}} transition='0.7s' display={colorMode === 'dark' ? 'block' : 'none'} maxH='100%' src={chairD} boxSize={['250px', '300px', '375px', '450px', '525px', '600px']} />
      </Box>
    </Flex>
  )
}
