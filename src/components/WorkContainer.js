  ...
  return (
    <Box w='80%' h='95%' borderStyle='dashed' border={['0px', '1px', '2px', '4px', '4px', '4px']} textAlign='center' borderRadius='lg'>
        ...
        <Flex h='70%' flexDirection={['column', 'column', 'column', 'row', 'row', 'row']} alignItems='center' justify='center'>
            <Image mx={[0, 1, 2, 'auto', 'auto', 'auto']} my={4} p={1} src={data.min1} maxW={['70%', '70%', '70%', '45%', '45%', '45%']} maxH = {['45%', '45%', '45%', '100%', '100%', '100%']} alt ='Image1' borderRadius='2xl' border={['4px', '2px', '2px', '2px', '2px', '2px']}></Image>
            <Image mx={[0, 1, 2, 'auto', 'auto', 'auto']} my={4} p={1} src={data.min2} maxW={['70%', '70%', '70%', '45%', '45%', '45%']} maxH = {['45%', '45%', '45%', '100%', '100%', '100%']} alt ='Image2' borderRadius='2xl' border={['4px', '2px', '2px', '2px', '2px', '2px']}></Image>
        </Flex>
